...
public class ElechamberMenu extends AbstractContainerMenu {

    public final ElechamberBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;
    private  FluidStack fluidStackIN;
    private  FluidStack fluidStackOUT;

    public ElechamberMenu(int id, Inventory inv, FriendlyByteBuf extraData){
        this(id,inv,inv.player.level.getBlockEntity(extraData.readBlockPos()),new SimpleContainerData(2));
    }
    public ElechamberMenu(int id, Inventory inv, BlockEntity entity, ContainerData data){
        super(ModMenuTypes.ELECHAMBER_MENU.get(), id);
        checkContainerSize(inv,4); //size of inv
        blockEntity = (ElechamberBlockEntity) entity;
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            ...
            this.addSlot(new SlotItemHandler(handler, 1, 7, 53));
    ...
    public int getScaledProgress() {
        ...
        int progressArrowSize = 90; // This is the height in pixels of your arrow
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.ELECHAMBER.get());
    }
    ...
    public ElechamberBlockEntity getBlockEntity() {
