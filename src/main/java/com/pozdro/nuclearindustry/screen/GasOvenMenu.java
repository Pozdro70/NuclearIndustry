...
public class GasOvenMenu extends AbstractContainerMenu {

    public final GasOvenBlockEntity blockEntity;
    ...
    public GasOvenMenu(int id, Inventory inv, FriendlyByteBuf extraData){
        this(id,inv,inv.player.level.getBlockEntity(extraData.readBlockPos()),new SimpleContainerData(2));
    }
    public GasOvenMenu(int id, Inventory inv, BlockEntity entity, ContainerData data){
        super(ModMenuTypes.GASOVEN_MENU.get(), id);
        checkContainerSize(inv,4); //size of inv
        blockEntity = (GasOvenBlockEntity) entity;
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 8, 72-4));
            this.addSlot(new SlotItemHandler(handler, 1, 28, 72-4));
            this.addSlot(new SlotItemHandler(handler, 2, 56, 53-4));
            this.addSlot(new SlotItemHandler(handler, 3, 116, 53-4));
        });
    ...
    public GasOvenBlockEntity getBlockEntity() {
    ...
    public void setFluidInIN1Tank(FluidStack fluidStackIN) {
        this.fluidStackIN1 = fluidStackIN;
    }
