package com.pozdro.nuclearindustry.screen.renderer;
    ...
    public List<Component> getTooltip(FluidStack fluidStack, TooltipFlag tooltipFlag) {
        ...
        try {
            ...
            if (tooltipMode == TooltipMode.SHOW_AMOUNT_AND_CAPACITY) {
                MutableComponent amountString = Component.translatable("nuclearindustry.tooltip.liquid.amount.with.capacity", milliBuckets, capacity);
                tooltip.add(amountString.withStyle(ChatFormatting.GRAY));
            } else if (tooltipMode == TooltipMode.SHOW_AMOUNT) {
                MutableComponent amountString = Component.translatable("nuclearindustry.tooltip.liquid.amount", milliBuckets);
                tooltip.add(amountString.withStyle(ChatFormatting.GRAY));
            }
