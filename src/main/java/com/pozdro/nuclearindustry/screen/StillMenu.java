...
public class StillMenu extends AbstractContainerMenu {
    ...
    public final StillBlockEntity blockEntity;
    ...
    public StillMenu(int id, Inventory inv, FriendlyByteBuf extraData){
        this(id,inv,inv.player.level.getBlockEntity(extraData.readBlockPos()),new SimpleContainerData(2));
    }
    public StillMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.STILL_MENU.get(), id);
        checkContainerSize(inv,3); //size of inv
        blockEntity = (StillBlockEntity) entity;
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler,0,9,8));
            this.addSlot(new SlotItemHandler(handler,1,48,55));
            this.addSlot(new SlotItemHandler(handler,2,135,55));
        });
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level,blockEntity.getBlockPos()),pPlayer, ModBlocks.STILL.get());
    }
    ...
    public StillBlockEntity getBlockEntity() {
