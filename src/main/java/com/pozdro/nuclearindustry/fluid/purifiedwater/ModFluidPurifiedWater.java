...
public class ModFluidPurifiedWater {
    ...
    public static final RegistryObject<FluidType> PURIFIEDWATER_FLUID_TYPE = register("purifiedwater_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(WATER_STILL_RL, WATER_FLOWING_RL, OVERLAY_RL,
                0xA192B8D6, new Vector3f(146f / 255f, 184f / 255f, 214f / 255f), properties));
    }
