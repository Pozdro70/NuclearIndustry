...
public class ModFluidSulfurDioxide {
    ...
    public static final RegistryObject<FluidType> SULFURDIOXIDE_FLUID_TYPE = register("sulfurdioxide_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(WATER_STILL_RL, WATER_FLOWING_RL, OVERLAY_RL,
                0xA18F8F59, new Vector3f(143f / 255f, 143f / 255f, 89f / 255f), properties));
    }
