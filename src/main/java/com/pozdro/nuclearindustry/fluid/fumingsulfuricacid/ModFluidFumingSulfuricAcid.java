...
public class ModFluidFumingSulfuricAcid {
    ...
    public static final RegistryObject<FluidType> FUMINGSULFURICACID_FLUID_TYPE = register("fumingsulfuricacid_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(WATER_STILL_RL, WATER_FLOWING_RL, OVERLAY_RL,
                0xA1B5B464, new Vector3f(181f / 255f, 180f / 255f, 100f / 255f), properties));
    }
