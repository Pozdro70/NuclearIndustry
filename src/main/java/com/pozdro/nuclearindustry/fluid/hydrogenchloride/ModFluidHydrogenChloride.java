...
public class ModFluidHydrogenChloride {
    ...
    public static final RegistryObject<FluidType> HYDROGENCHLORIDE_FLUID_TYPE = register("hydrogenchloride_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(WATER_STILL_RL, WATER_FLOWING_RL, OVERLAY_RL,
                0xA1FFFEE0, new Vector3f(255f / 255f, 254f / 255f, 224f / 255f), properties));
    }
