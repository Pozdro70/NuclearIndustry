...
public class ModFluidChloride {
    ...
    public static final RegistryObject<FluidType> CHLORIDE_FLUID_TYPE = register("chloride_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(WATER_STILL_RL, WATER_FLOWING_RL, OVERLAY_RL,
                0xA1BED41E, new Vector3f(190f / 255f, 212f / 255f, 30f / 255f), properties));
    }
