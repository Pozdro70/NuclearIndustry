...
public class ModFluidSodiumHydroxideSolution {
    ...
    public static final RegistryObject<FluidType> SODIUMHYDROXIDESOLUTION_FLUID_TYPE = register("sodium_hydroxide_solution_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(WATER_STILL_RL, WATER_FLOWING_RL, OVERLAY_RL,
                0xA1DBDBDB, new Vector3f(219f / 255f, 219f/255f, 219f / 255f), properties));
    }
