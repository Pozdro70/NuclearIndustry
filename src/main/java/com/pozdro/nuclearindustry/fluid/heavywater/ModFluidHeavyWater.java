...
public class ModFluidHeavyWater {
    ...
    public static final RegistryObject<FluidType> HEAVYWATER_FLUID_TYPE = register("heavywater_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(WATER_STILL_RL, WATER_FLOWING_RL, OVERLAY_RL,
                0xA1546bf0, new Vector3f(84f / 255f, 107f / 255f, 240f / 255f), properties));
    }
