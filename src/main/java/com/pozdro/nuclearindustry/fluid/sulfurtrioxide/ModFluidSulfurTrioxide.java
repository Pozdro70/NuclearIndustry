...
public class ModFluidSulfurTrioxide {
    ...
    public static final RegistryObject<FluidType> SULFURTRIOXIDE_FLUID_TYPE = register("sulfurtrioxide_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(WATER_STILL_RL, WATER_FLOWING_RL, OVERLAY_RL,
                0xA1D1FF52, new Vector3f(209f / 255f, 1f, 82f / 255f), properties));
    }
