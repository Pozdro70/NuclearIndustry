...
public class ModFluidHydrochloricAcid {
    ...
    public static final RegistryObject<FluidType> HYDROCHLORICACID_FLUID_TYPE = register("hydrochloricacid_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(WATER_STILL_RL, WATER_FLOWING_RL, OVERLAY_RL,
                0xA1FFF7E8, new Vector3f(255f / 255f, 247f / 255f, 232f / 255f), properties));
    }
